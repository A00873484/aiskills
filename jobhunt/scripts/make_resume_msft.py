"""
Resume generator — tailored for Microsoft SWE II Full Stack (Fabric Data Engineering)
Emphasizes: React/TypeScript full-stack, Python, LLM-RAG Pipeline, end-to-end ownership
"""
...
OUTPUT_PDF = os.path.join(_cfg["resumes_dir"], "daniel_engelhard_resume_msft_fabric.pdf")
...
RESUME_TEXT = (
    ...
    "Full-stack engineer with 3+ years at Microsoft shipping React/TypeScript features at scale. "
    "Hands-on AI engineering background — built a working RAG pipeline with Python embeddings, "
    "vector search, and a TypeScript UI. Strong ownership mentality; led full product lifecycles "
    "from design to production.\n"
    "SKILLS\n"
    "Frontend: TypeScript, React, Next.js, Angular, Stencil, HTML/CSS, SASS, Tailwind CSS, Fluent UI patterns\n"
    "Backend: Python, Node.js, PostgreSQL, MySQL, REST APIs, Socket.io, PHP\n"
    "AI/ML: LLM integration, RAG pipelines, vector embeddings, prompt engineering, Docker Compose\n"
    "Tooling: Git, ESLint, CI/CD, Playwright, Storybook, Google Analytics, Linux/CLI\n"
    "EXPERIENCE\n"
    "<<<ROLE0>>>\n"
    "Core contributor (2nd highest) on a Stencil/TypeScript platform used by 10+ product teams — drove adoption, DX tooling, and automated WCAG enforcement in CI\n"
    "Expanded content moderation platform from image/text to full video pipeline — end-to-end ownership across frontend and backend surfaces\n"
    "Built automated ESLint accessibility rules that caught WCAG violations in PRs before they shipped, enforced across all consuming teams\n"
    "Instrumented Google Analytics across multiple product surfaces; designed event taxonomies and dashboards for product and engineering\n"
    "Mentored engineers on platform usage and accessibility standards; led code reviews and contributed to shared engineering documentation\n"
    "Promoted before the 2025 layoffs; left in good standing as a core platform contributor\n"
    "<<<ROLE1>>>\n"
    "Resolved production issues in a legacy TypeScript codebase under agile sprint conditions\n"
    "Collaborated across daily standups, code reviews, and sprint planning on a cross-functional team\n"
    "<<<ROLE2>>>\n"
    "Sole developer for 5+ years on a real-time multiplayer Bingo & Trivia gaming suite for live pub events — full product lifecycle\n"
    "Built real-time multiplayer engine with Socket.io, Icecast audio streaming, and a live points/rewards system\n"
    "Stack: Angular, Ionic, Node.js, PHP, MySQL — deployed and maintained cross-platform (iOS, Android, web)\n"
    "SIDE PROJECTS\n"
    "LLM-RAG Pipeline: Python embedding server, vector search backend, TypeScript frontend — full Docker Compose orchestration, end-to-end AI engineering\n"
    "Payment App: Tokenized payment links, Google Sheets sync, admin dashboard — Next.js 15, Prisma, PostgreSQL, AlphaPay integration\n"
    "Inventory Automation: Google Apps Script + AppSheet for a $75K/yr resale business — order tracking and cross-border logistics\n"
    "EDUCATION\n"
...
for role in reversed(ROLES):
    ...
    # 2b: Insert table at marker position
    batch_update([
